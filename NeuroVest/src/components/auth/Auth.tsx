    ...
    <>
      ...
      <div className="container flex mx-auto px-5 sm:px-0 min-h-[80vh]">
        ...
        <div className="mt-[100px] w-full lg:w-3/6 ">
          ...
          {/* Hero title */}
          <h1 className="text-7xl pb-5 font-extrabold ml-[-4px] sm:text-left text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-900 drop-shadow-md">NeuroVest</h1>
